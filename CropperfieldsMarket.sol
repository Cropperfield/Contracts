...
contract CropperfieldsMarket is ReentrancyGuard, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _itemIds;
    Counters.Counter private _itemsSold;
    mapping(uint=>address) private AcceptedNFTContracts;
    uint private AcceptedContracts = 1;
    address public MagicFarm;
    address public Team;
    uint256 public MagicFarmPercentage = 400;
    uint256 public TeamPercentage = 200;

     constructor(address _NFTContract,address _MagicFarm, address _Team) {
         AcceptedNFTContracts[0] = _NFTContract;
