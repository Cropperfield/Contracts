...
contract Cropperfield is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Marketingwallet = payable(0xaE9c0CAcB6D57461b4942B3E3c6Aa049aFBe15C2); 
    address payable private NFTFarm; 
    address payable private NFTs; 
    address payable private Wallet_Dev = payable(0xCE77EAF7c6cEb13141E91da918b3EceA368a5C7D);
    ...
    */
    ...
    string private _name = "Cropperfield"; 
    string private _symbol = "CROpperfield";  
    ...
    uint256 public NFTFarmFee = 4000;
    uint256 public MarketingFee = 2000;
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[NFTFarm] = true;
    ...
    */
    ...
    function _set_Distribution_Fees(uint256 LiquidityFeex1000, uint256 NFTFarmFeex1000,uint256 MarketingFeex1000,uint256 TeamFeex1000) external onlyOwner() {
         ...
         TotalfeeforDistribution = LiquidityFee.add(NFTFarmFee).add(MarketingFee).add(TeamFee);
    ...
    function Wallet_Update_NFTFarm(address payable NFTFarmwallet) public onlyOwner() {
        NFTFarm = NFTFarmwallet;
        _isExcludedFromFee[NFTFarm] = true;
    }
    ...
    function Wallet_Update_Marketing(address payable MarketingWallet) public onlyOwner() {
      ...
      // Update Marketing wallet
    function Wallet_Update_NFTs(address payable NFTsWallet) public onlyOwner() {
        NFTs = NFTsWallet;
        _isExcludedFromFee[NFTsWallet] = true;
    }
    /*
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 amountCRONFTFarm = amountCRO.mul(NFTFarmFee).div(totalCROFee);
        uint256 amountCROMarketing = amountCRO.mul(MarketingFee).div(totalCROFee);
        uint256 amountCROTeam = amountCRO.sub(amountCROLiquidity).sub(amountCRONFTFarm).sub(amountCROMarketing);
         ...
         if (amountCRONFTFarm > 0) {
             sendToWallet(NFTFarm,amountCRONFTFarm);
            emit NFTFarmSent(NFTFarm, amountCRONFTFarm);
         }
    ...
    // Swapping tokens for CRO using MM Finance 
    ...
    */
    ...
    UPDATE MM.FINANCE ROUTER AND LIQUIDITY PAIRING
